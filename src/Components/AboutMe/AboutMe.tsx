  ...
  return (
    <section className={styles.aboutMe}>
      ...
      <div className={styles.paragraphDiv}>
        <p className={styles.paragraph}>Me chamo Túlio, 24 anos, atualmente estudante de Desenvolvimento Web Full Stack pela Trybe.</p>
        <p className={styles.paragraph}>Concluí o modulo de Front End, e o Back End em andamento.</p>
